...
module.exports.buildMsg = function buildMsg(device) {
  return {
    position: {
      ...
      latitude: AIRPORT_COORDINATES[device.estacion].latitude + getRandomInt(1,9)/10000,
      longitude: AIRPORT_COORDINATES[device.estacion].longitude + getRandomInt(1,9)/10000,
